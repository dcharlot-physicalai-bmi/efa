...
| `ebm_dpend.rs` | **harder body (honest negative)** — chaotic double pendulum; physics verified exact (drift 0), but recovering the conserved energy from trajectories resisted 3 objectives (corr ≈0.03–0.11 vs 0.99 single-pendulum). Ill-posed; correct next method = HNN in canonical coordinates |
